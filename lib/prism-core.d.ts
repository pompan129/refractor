export namespace Prism {
    ...
    export namespace languages {
        ...
        export function extend(id: string, redef: {
            [x: string]: RegExp | GrammarToken | (RegExp | GrammarToken)[];
        }): {
            [x: string]: RegExp | GrammarToken | (RegExp | GrammarToken)[];
        };
        export function insertBefore(inside: string, before: string, insert: {
            [x: string]: RegExp | GrammarToken | (RegExp | GrammarToken)[];
        }, root?: {
            [x: string]: any;
        } | undefined): {
    ...
    export function highlight(text: string, grammar: {
        [x: string]: RegExp | GrammarToken | (RegExp | GrammarToken)[];
    }, language: string): string;
    export function tokenize(text: string, grammar: {
        [x: string]: RegExp | GrammarToken | (RegExp | GrammarToken)[];
    }): TokenStream;
 ...
 * @public
 */
declare function Token(type: string, content: string | TokenStream, alias?: string | string[] | undefined, matchedStr?: string | undefined): void;
declare class Token {
    /**
     * Creates a new token.
     *
     ...
     * @public
     */
    constructor(type: string, content: string | TokenStream, alias?: string | string[] | undefined, matchedStr?: string | undefined);
    /**
