 ...
 */
declare function highlight(value: string, language: string | Grammar): RefractorRoot;
/**
 ...
 * @returns {void}
 */
declare function alias(language: Record<string, string | Array<string>> | string, alias?: string | string[] | undefined): void;
/**
 * Register a syntax.
 *
 * @param {Syntax} syntax
